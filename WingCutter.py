...
class CutterTools():
    ...
    def fucking_magic(self,root,tip,feed_rate,cut_radius): #Refactered, maybe working, if god knows he aint tellin
        ...
        #This program does not support curves with more than 2 co-linear points
        self.root_dat = root
        self.tip_dat = tip
...
class GUI():
    def __init__(self):
        ...
        Label(self.window,text="Beta 1.2").place(x=420,y=570)
        ...
        for x in range(100,0,-1):
            ...
            if self.pp<=self.max_camber_pos:
                ...
                if self.max_camber!=0:
                    ...
                    self.camber_offset = 0
                    self.offset_theta = 0
            self.store.append(self.offset_theta)
    ...
    def compute_geometry(self):#Known Good, Tested
        print(len(self.true_root_foil),len(self.true_tip_foil))
        ...
        print(len(self.resampled_root_foil),len(self.resampled_tip_foil))
